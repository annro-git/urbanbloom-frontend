...
const GardenCard = ({ name, description, ppURI, members, setGarden }) => {
    return (
        <View style={{ borderRadius: 10, padding: 20, backgroundColor: '#BDCEBB', width: '100%', gap: 20 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 20 }}>
                ...
                <View style={{ flex: 1, gap: 10, paddingTop: 10 }}>
                    ...
                    <Button text='Participer' primary='#466760' secondary='white' fontSize={ 16 } padding={ 10 } onPress={() => setGarden()} />
                </View>
            </View>
        </View>
    )
